...
import sidetrek
from project.wf_85_471.main import Hyperparameters
from project.wf_85_471.main import create_df
from project.wf_85_471.main import clean_ds
from project.wf_85_471.main import handle_cat_cols
from project.wf_85_471.main import split_train_test
from project.wf_85_471.main import train_model
...
@workflow
def wf_85(_wf_args:Hyperparameters)->_wf_outputs:
	...
	train_model_o0_=train_model(X_train=split_train_test_o0_,y_train=split_train_test_o2_,hp=_wf_args)
